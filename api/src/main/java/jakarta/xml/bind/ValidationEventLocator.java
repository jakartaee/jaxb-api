 ...
 *
 * <p>
 * The {@code ValidationEventLocator} indicates where the {@code ValidationEvent} occurred.  Different fields will be
 * set depending on the type of validation that was being performed when the error or warning was detected. For example,
 * on-demand validation would produce locators that contained references to objects in the Java content tree while
