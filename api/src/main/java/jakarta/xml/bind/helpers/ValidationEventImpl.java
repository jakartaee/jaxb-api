...
public class ValidationEventImpl implements ValidationEvent {
     ...
     * @param _message         The text message for this event - may be null.
     * @param _locator         The locator object for this event - may be null.
     * @param _linkedException An optional linked exception that may provide additional information about the event -
     *                         may be null.
     *
     * @throws IllegalArgumentException if an illegal severity field is supplied
     */
     ...
     *
     * @param _severity Must be one of ValidationEvent.WARNING, ValidationEvent.ERROR, or ValidationEvent.FATAL_ERROR.
     *
     * @throws IllegalArgumentException if an illegal severity field is supplied
     */
