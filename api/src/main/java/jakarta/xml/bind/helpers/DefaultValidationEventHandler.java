...
/**
 * <p>
 * JAXB 1.0 only default validation event handler. This is the default handler for all objects created from a
 * JAXBContext that is managing schema-derived code generated by a JAXB 1.0 binding compiler.
 *
 * <p>
 * This handler causes the unmarshal and validate operations to fail on the first error or fatal error.
 *
 * <p>
 * This handler is not the default handler for Jakarta XML Binding mapped classes following Jakarta XML Binding or later
