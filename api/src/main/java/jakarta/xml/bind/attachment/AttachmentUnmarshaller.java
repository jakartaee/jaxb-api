 ...
 * binary data formats between a Jakarta XML Binding implementation and MIME-based package processor (MTOM/XOP and WS-I
 * AP 1.0). Jakarta XML Binding unmarshalls the body of a package, delegating the understanding of the packaging format
 * being used to a MIME-based package processor that implements this abstract class.</p>
 *
 * <p>This abstract class identifies if a package requires XOP processing, {@linkplain #isXOPPackage()}
...
public abstract class AttachmentUnmarshaller {
    ...
    /**
     * <p>Lookup MIME content by content-id, {@code cid}, and return as a {@linkplain DataHandler}.</p>
     *
     ...
     *
     * @param cid It is expected to be a valid lexical form of the XML Schema {@code xs:anyURI} datatype. If
     *            {@linkplain #isXOPPackage()}{@code ==true}, it must be a valid URI per the {@code cid:} URI scheme
     *            (see <a href="http://www.ietf.org/rfc/rfc2387.txt">RFC 2387</a>)
     *
     * @return a {@linkplain DataHandler} that represents the MIME attachment.
     ...
     * in  <a href="http://www.w3.org/TR/2005/REC-xop10-20050125/#identifying_xop_documents">Identifying XOP
