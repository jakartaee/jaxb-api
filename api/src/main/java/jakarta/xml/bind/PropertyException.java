...
public class PropertyException extends JAXBException {
    ...
    /**
     * Construct a PropertyException with the specified detail message.  The errorCode and linkedException will default
     * to null.
     *
    ...
    /**
     * Construct a PropertyException with the specified detail message and vendor specific errorCode.  The
    ...
    /**
     * Construct a PropertyException with a linkedException.  The detail message and vendor specific errorCode will
     * default to null.
     *
    ...
    /**
     * Construct a PropertyException with the specified detail message and linkedException.  The errorCode will default
     * to null.
     *
     * @param message   a description of the exception
     * @param exception the linked exception
