...
/**
 * <p>
 * The DatatypeConverterInterface is for Jakarta XML Binding provider use only. A Jakarta XML Binding provider must
 * supply a class that implements this interface. Jakarta XML Binding Providers are required to call the
 * {@linkplain DatatypeConverter#setDatatypeConverter(DatatypeConverterInterface)
 * DatatypeConverter.setDatatypeConverter} api at some point before the first marshal or unmarshal operation (perhaps
 * during the call to JAXBContext.newInstance).  This step is necessary to configure the converter that should be used
 * to perform the print and parse functionality.  Calling this api repeatedly will have no effect - the
 * DatatypeConverter instance passed into the first invocation is the one that will be used from then on.
 *
 * <p>
 * This interface defines the parse and print methods. There is one parse and print method for each XML schema datatype
 * specified in the the default binding Table 5-1 in the Jakarta XML Binding specification.
 *
 * <p>
 * The parse and print methods defined here are invoked by the static parse and print methods defined in the
 * {@linkplain DatatypeConverter DatatypeConverter} class.
 *
 * <p>
 * A parse method for an XML schema datatype must be capable of converting any lexical representation of the XML schema
 * datatype ( specified by the
 * <a href="http://www.w3.org/TR/xmlschema-2/"> XML Schema Part2: Datatypes
 * specification</a> into a value in the value space of the XML schema datatype. If an error is encountered during
 * conversion, then an IllegalArgumentException or a subclass of IllegalArgumentException must be thrown by the method.
 *
 * <p>
...
public interface DatatypeConverterInterface {
     ...
     * @throws NumberFormatException {@code lexicalXSDInteger} is not a valid string representation of a
     ...
     * @throws NumberFormatException {@code lexicalXSDInt} is not a valid string representation of an {@code int}
     *                               value.
     */
     ...
     * @throws NumberFormatException {@code lexicalXSDLong} is not a valid string representation of a {@code long}
     *                               value.
     */
     ...
     * @throws NumberFormatException {@code lexicalXSDShort} is not a valid string representation of a {@code short}
     *                               value.
     */
     ...
     * @throws NumberFormatException {@code lexicalXSDDecimal} is not a valid string representation of
     ...
     * @throws NumberFormatException {@code lexicalXSDFloat} is not a valid string representation of a {@code float}
     *                               value.
     */
     ...
     * @throws NumberFormatException {@code lexicalXSDDouble} is not a valid string representation of a {@code double}
     *                               value.
     */
