 ...
 * Customizations can involve writing a parse and print method for parsing and printing lexical representations of an
 * XML schema datatype respectively. However, writing parse and print methods requires knowledge of the lexical
 * representations (
 * <a href="http://www.w3.org/TR/xmlschema-2/"> XML Schema Part2: Datatypes
 * specification </a>) and hence may be difficult to write.
 * </p>
 * <p>
 * This class makes it easier to write parse and print methods. It defines static parse and print methods that provide
 * access to a Jakarta XML Binding provider's implementation of parse and print methods. These methods are invoked by
 * custom parse and print methods. For example, the binding of xsd:dateTime to a long can be customized using parse and
 * print methods as follows:
 * {@snippet :
 ...
 * {@linkplain DatatypeConverterInterface DatatypeConverterInterface}.
 * <p>
 ...
 * {@linkplain #setDatatypeConverter(DatatypeConverterInterface) setDatatypeConverter} api at some point before the
 * first marshal or unmarshal operation (perhaps during the call to JAXBContext.newInstance).  This step is necessary to
 * configure the converter that should be used to perform the print and parse functionality.
 * </p>
 *
 * <p>
 * A print method for an XML schema datatype can output any lexical representation that is valid with respect to the XML
 * schema datatype. If an error is encountered during conversion, then an IllegalArgumentException, or a subclass of
...
final public class DatatypeConverter {
     ...
     * <p>
     * Jakarta XML Binding Providers are required to call this method at some point before allowing any of the Jakarta
     * XML Binding client marshal or unmarshal operations to occur.  This is necessary to configure the datatype
     * converter that should be used to perform the print and parse conversions.
     *
     * <p>
     * Calling this api repeatedly will have no effect - the DatatypeConverterInterface instance passed into the first
     * invocation is the one that will be used from then on.
     *
     * @param converter an instance of a class that implements the DatatypeConverterInterface class - this parameter
     *                  must not be null.
     *
     ...
     * @throws NumberFormatException <code>lexicalXSDInteger</code> is not a valid string representation of a
     *                               {@linkplain java.math.BigInteger} value.
     */
     ...
     * @throws NumberFormatException <code>lexicalXSDInt</code> is not a valid string representation of an
     *                               <code>int</code> value.
     */
     ...
     * @throws NumberFormatException <code>lexicalXSDLong</code> is not a valid string representation of a
     ...
     * @throws NumberFormatException <code>lexicalXSDShort</code> is not a valid string representation of a
     ...
     * @throws NumberFormatException <code>lexicalXSDDecimal</code> is not a valid string representation of
     *                               {@linkplain java.math.BigDecimal}.
     */
     ...
     * @throws NumberFormatException <code>lexicalXSDFloat</code> is not a valid string representation of a
     ...
     * @throws NumberFormatException <code>lexicalXSDDouble</code> is not a valid string representation of a
     ...
     *                                  Schema Part 2: Datatypes for xsd:boolean.
     */
     ...
     * @throws IllegalArgumentException if string parameter does not conform to lexical value space defined in XML
     *                                  Schema Part 2: Datatypes for xsd:byte.
     */
     ...
     * @throws IllegalArgumentException if string parameter does not conform to XML Schema Part 2 specification or if
     *                                  namespace prefix of {@code lexicalXSDQname} is not bound to a URI in
     *                                  NamespaceContext {@code nsc}.
     */
     ...
     * @throws IllegalArgumentException if string parameter does not conform to lexical value space defined in XML
     *                                  Schema Part 2: Datatypes for xsd:base64Binary
     */
     ...
     * @return An array of bytes represented by the string argument.
     * @throws IllegalArgumentException if string parameter does not conform to lexical value space defined in XML
     *                                  Schema Part 2: Datatypes for xsd:hexBinary.
     */
     ...
     *
     * @param lexicalXSDUnsignedShort A string containing lexical representation of xsd:unsignedShort.
     *
     * @return An int value represented by the string argument.
     ...
     * @throws IllegalArgumentException if string parameter does not conform to lexical value space defined in XML
     *                                  Schema Part 2: Datatypes for xsd:Time.
     */
     ...
     * @throws IllegalArgumentException if {@code val} is null or if {@code nsc} is non-null or
     *                                  {@code nsc.getPrefix(nsprefixFromVal)} is null.
     */
